...
# 디렉토리를 정의합니다.
train_dir = '../datasets/final_texture_datasets/train'
val_dir = '../datasets/final_texture_datasets/val'
test_dir = '../datasets/final_texture_datasets/test'
...
# 모델 인스턴스 생성
model = VGG16CNN(num_classes=3).to(device)
...
torch.save(model.state_dict(), f'texture_model{num_epochs}epoch_{batch_size}batch.pth')
